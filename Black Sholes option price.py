...
def bs_call(S, K, r, sigma, t):
    ...
    return math.exp(-t) * S * norm.cdf(d1) - \
        math.exp(-r * t) * K * norm.cdf(d2)
...
y2 = df['45950']
y3 = df['45960']
# regress and predict implied volatilities on 20170825, then regard them
# as ivs on 20200825
...
portfolio_super = 7.5 / 45.95 * \
    (61.26 - d) - 7.5 / 45.95 * digital_call_1 + 2.5 * super * 100 + 16.379 / 61.26 * call
portfolio_sub = 7.5 / 45.95 * (61.26 - d) - 7.5 / 45.95 * \
    digital_call_2 + 2.5 * sub * 100 + 16.379 / 61.26 * call
...
portfolio2_super = -7.5 / 45.95 * put_super + 7.5 / \
    (1 + 1.631192132 / 100)**5 + 2.5 * super * 100 + 16.379 / 61.26 * call
portfolio2_sub = -7.5 / 45.95 * put_sub + 7.5 / \
    (1 + 1.631192132 / 100)**5 + 2.5 * sub * 100 + 16.379 / 61.26 * call
